...
import ProfileStartScreen from './ProfileStartScreen.js';
  ...
  render() {
    let makeElementForScreen = (screenId, baseProps, atTop, forward) => {
      ...
      switch (screenId) {
        default:
          return null;
        case 'uploadphotopop2':
          return (<UploadPhotoPop2Screen {...screenProps} />)
        case 'uploadphotopop':
          return (<UploadPhotoPopScreen {...screenProps} />)
        case 'profilestart':
          return (<ProfileStartScreen {...screenProps} />)
      }
    }
